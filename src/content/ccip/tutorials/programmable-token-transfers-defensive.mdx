...
1.  Open MetaMask and connect to _Ethereum Sepolia_. Fund your contract with LINK tokens. You can transfer <CopyText text="0.05" code/> _LINK_ to your contract. In this example, LINK is used to pay the CCIP fees.
...
1.  Send a string data with tokens from _Ethereum Sepolia_:
    ...
    1.  After the transaction is successful, record the transaction hash. Here is an [example](https://sepolia.etherscan.io/tx/0x93e6da2389ad91b2a96f9a8f022dd6ea7e07aef49f8194e42b95ffc70ffed03b) of a transaction on _Ethereum Sepolia_.
        ...
        During gas price spikes, your transaction might fail, requiring more than _0.05 LINK_ to proceed. If your transaction fails, fund your contract with more _LINK_ tokens and try again.
